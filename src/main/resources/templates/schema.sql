CREATE TABLE Car (id INT NOT NULL Primary Key AUTO_INCREMENT, model VARCHAR(100), colour VARCHAR(100), price DECIMAL(12,2), brand VARCHAR(100),year DECIMAL(12,2),picture VARCHAR(100));

INSERT INTO Car (model,colour, price, brand, year,picture) VALUES
('Q5 Kmofort','Black',31900.00,'Audi',2015,'asd');
